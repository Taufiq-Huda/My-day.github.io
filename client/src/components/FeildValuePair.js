...
export default function FeildValuePair(props) {
  ...
  return (
    <div className="sub-section d-flex flex-row">
      <input type="text" className="form-control" placeholder={props.txt_label} aria-label="test2" value={text} onChange={UpdateFeildDisplay} onBlur={UpdateInBackend}/>
      <span className="input-group-text">@</span>
      <input type="number" className="form-control" placeholder={props.num_label} aria-label={props.num_label} value={value} onChange={UpdatValue} onBlur={UpdateInBackend}/>
    </div>
  );
}
